...
class _AddEditMemberState extends State<AddEditMember> {
  ...
  Widget build(BuildContext context) {
    ...
    final _phoneField = TextFormField(
      ...
      validator: (val) {
        // phone is optional, only validate the format
      ...
      // persist an explicit null when the field is left empty
      onSaved: (val) => _memberCreationProvider.currentMember.phone = (val != null && val.isNotEmpty) ? val : null,
